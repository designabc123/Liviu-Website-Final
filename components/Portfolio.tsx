...
const PORTFOLIO_DATA: PortfolioItem[] = [
  ...
  { 
    ...
    title: 'ILLUSTRATION', 
    className: 'col-span-1 row-span-1', 
    coverImage: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718501/Skin_Vector_dcdp8c.jpg', 
    type: 'image', 
    items: [
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718501/Skin_Vector_dcdp8c.jpg', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718501/Skin_Vector_dcdp8c.jpg' },
  ...
  { 
    ...
    title: 'LOGO DESIGN', 
    className: 'col-span-1 row-span-1', 
    coverImage: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718613/LumiHeal-Logo-01-Black_dh03ze.png', 
    type: 'image', 
    items: [
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718613/LumiHeal-Logo-01-Black_dh03ze.png', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718613/LumiHeal-Logo-01-Black_dh03ze.png' },
  ...
  { 
    ...
    title: 'PACKAGING', 
    className: 'col-span-1 row-span-1', 
    coverImage: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718733/klerasca_rosacea_01_kvmtsi.png', 
    type: 'image', 
    items: [
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718733/klerasca_rosacea_01_kvmtsi.png', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718733/klerasca_rosacea_01_kvmtsi.png' },
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718820/Safe_Test_vdrfir.jpg', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718820/Safe_Test_vdrfir.jpg' },
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718915/Nervisel_a3hp3u.jpg', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718915/Nervisel_a3hp3u.jpg' },
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718985/Herbal_Tea_cpb8cy.jpg', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769718985/Herbal_Tea_cpb8cy.jpg' },
      { type: 'image', src: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769719077/End_of_Acne_elxpbk.jpg', thumb: 'https://res.cloudinary.com/dao9flvhw/image/upload/v1769719077/End_of_Acne_elxpbk.jpg' },
